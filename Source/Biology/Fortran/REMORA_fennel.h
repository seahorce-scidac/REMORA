...
!
        ...
        END DO
!
        CALL fennel_tag ('G00_PRE   ', 0, Istr, Iend, j,
     &                   IminS, ImaxS, N(ng), NT(ng), Bio)
!
!=======================================================================
...
!
                ...
                fac3=MAX(fac2/(3.0_r8+fac2),0.0_r8) ! MM for O2 dep
...
# endif
     &                                N_Flux_Nitrifi*fiter
          ...
          END DO
!
          CALL fennel_tag ('G01_LIGHT ', Iter, Istr, Iend, j,
     &                     IminS, ImaxS, N(ng), NT(ng), Bio)
!
!-----------------------------------------------------------------------
...
!
     ...
     &                       (PhyCN(ng)-ZooCN(ng))*N_Flux_Assim
          ...
          END DO
!
          CALL fennel_tag ('G02_GRAZE ', Iter, Istr, Iend, j,
     &                     IminS, ImaxS, N(ng), NT(ng), Bio)
!
!-----------------------------------------------------------------------
...
!
     ...
     &                       N_Flux_Zexcret
          ...
          END DO
!
          CALL fennel_tag ('G03_ZMETAB', Iter, Istr, Iend, j,
     &                     IminS, ImaxS, N(ng), NT(ng), Bio)
!
!-----------------------------------------------------------------------
...
!
     ...
     &                       PhyCN(ng)*(N_Flux_CoagP+N_Flux_CoagD)
          ...
          END DO
!
          CALL fennel_tag ('G04_COAG  ', Iter, Istr, Iend, j,
     &                     IminS, ImaxS, N(ng), NT(ng), Bio)
!
!-----------------------------------------------------------------------
...
#endif
!
          CALL fennel_tag ('G05_REMINN', Iter, Istr, Iend, j,
     &                     IminS, ImaxS, N(ng), NT(ng), Bio)
#ifdef OXYGEN
!
!-----------------------------------------------------------------------
...
# endif
          ...
          END DO
!
          CALL fennel_tag ('G06_O2FLX ', Iter, Istr, Iend, j,
     &                     IminS, ImaxS, N(ng), NT(ng), Bio)
#endif
...
# endif
!
          CALL fennel_tag ('G07_REMINC', Iter, Istr, Iend, j,
     &                     IminS, ImaxS, N(ng), NT(ng), Bio)
!
!-----------------------------------------------------------------------
...
# endif
          END DO
!
          CALL fennel_tag ('G08_CO2FLX', Iter, Istr, Iend, j,
     &                     IminS, ImaxS, N(ng), NT(ng), Bio)
#endif
!
!-----------------------------------------------------------------------
...
# endif
          ...
          END DO SINK_LOOP
!
          CALL fennel_tag ('G09_SINK  ', Iter, Istr, Iend, j,
     &                     IminS, ImaxS, N(ng), NT(ng), Bio)
        END DO ITER_LOOP
!
        CALL fennel_tag ('G10_POST  ', BioIter(ng), Istr, Iend, j,
     &                   IminS, ImaxS, N(ng), NT(ng), Bio)
!
!-----------------------------------------------------------------------
...
# endif
        ...
        END DO
!
        CALL fennel_tag_t ('G11_UPDATE', BioIter(ng), Istr, Iend, j,
