...
# HIGH-RESOLUTION ANALYTIC INITIALIZATION BELOW THE HIGH-RESOLUTION GRID LEVEL
# The initial state is evaluated on level 1 over the bathymetry averaged down from level 2,
# not the analytic bathymetry at level 1.
# Reference: hires_init_analytic_reference.py --ref-ratio 3 --grid-ratio 6.
amr.max_level           = 2
amr.ref_ratio_vect      = 3 3 1 2 2 1
remora.hires_grid_level = 2
