...
# HIGH-RESOLUTION ANALYTIC INITIALIZATION ABOVE THE HIGH-RESOLUTION GRID LEVEL
# No grid data on level 2, so the analytic bathymetry is evaluated there (cumulative ratio 6).
# Reference: hires_init_analytic_reference.py --ref-ratio 6.
amr.max_level           = 2
amr.ref_ratio_vect      = 3 3 1 2 2 1
remora.hires_grid_level = 1
remora.hires_init_level = 2
