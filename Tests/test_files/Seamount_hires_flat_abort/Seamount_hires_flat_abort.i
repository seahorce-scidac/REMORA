...
# flat_bathymetry wins at level 0, so asking for both would silently ignore the
# high-resolution bathymetry -- and the flat branch writes a component vec_h_full_domain
# does not have.
amr.max_level           = 1
amr.ref_ratio_vect      = 3 3 1
remora.hires_grid_level = 1
remora.flat_bathymetry  = 1
